...
[Tasks]
Name: "startup"; Description: "Launch Dictate when I sign in"; GroupDescription: "Startup:"; Flags: unchecked checkedonce

[Dirs]
Name: "{localappdata}\Dictate"; Flags: uninsneveruninstall

[Files]
Source: "{#PublishDir}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "{#PublishDir}\settings.example.json"; DestDir: "{localappdata}\Dictate"; DestName: "settings.json"; Flags: onlyifdoesntexist uninsneveruninstall
Source: "{#PublishDir}\.env.example"; DestDir: "{localappdata}\Dictate"; DestName: ".env"; Flags: onlyifdoesntexist uninsneveruninstall
...
begin
  ...
  if not UninstallSilent then
    RemoveUserDataOnUninstall :=
      MsgBox(
        'Remove Dictate settings, API keys, and logs for this Windows user?',
        mbConfirmation,
...
begin
  ...
  begin
    ...
    if RemoveUserDataOnUninstall then
      DelTree(
        ExpandConstant('{localappdata}\Dictate'),
        True,
        True,
        True);
  end;
